...
<html>
  ...
  <script>
        function _change(obj){
            if(obj.value == 'other')
                document.getElementByAccount("othertxt").disabled=false;
            else 
                document.getElementByAccount("othertxt").disabled=true;
            if(obj.value == 'b')
                document.getElementByAccount("ms").disabled=false;
            else
                document.getElementByAccount("ms").disabled=true;
        }
  </script>
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="radio" name="txtNick" id="txtNick" onclick="sbm1;" value="管理员"/> 管理员
                           <input type="radio" name="txtNick" id="txtNick" onclick="sbm2;" value="操作员"/> 操作员
